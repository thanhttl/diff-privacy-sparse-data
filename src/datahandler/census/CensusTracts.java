...
public class CensusTracts {
	static int numTractDigits=3;
	static int lowerThreshold=10;
	...
	public static void main(String[] args) {
		...
		String tractFile = "data/map_freq_matrix/validTracts_" + numTractDigits + ".txt";
		//String tractFile = "data/map_freq_matrix/test_" + numTractDigits + ".txt";
		try {
		...
		HashMap<String, Integer> freqMatrix = new HashMap<String, Integer>();
		...
		ArrayList<String> countArray = new ArrayList<String>(freqMatrix.keySet());
		Collections.sort(countArray);
		String outFile = "data/map_freq_matrix/wholeUS_" + numTractDigits + "cutAt10.txt";
		try {
...
//				}
			...
			System.out.println("Num non-zeros: " + numNonZeros); // freqMatrix.size());
			System.out.println("Percentage of sparsity: " + (1- ((double) numNonZeros)/Math.pow(allTracts.size(), 2)));
			System.out.println("Avg non-zero entry: " + ((double) totalNum)/numNonZeros);
		}
		catch(Exception e) {
			e.printStackTrace();
			System.exit(1);
...
//		
	...
	public static void readFreqMatrix(String stateName, String stateCode, HashMap<String, Integer> fm, HashSet<String> tracts, int numDigits, int maxNumLines) {
